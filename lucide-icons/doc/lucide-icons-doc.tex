...
\NewDocumentCommand{\showcaselucideicons}{mm}{%name + macro + page
	\textcolor{violet}{\Large\lucideicon{#1}} & \itshape #1 & \ttfamily \textbackslash lucideicon\{#1\} & \sffamily #2 \\
}

\begin{document}

\title{The \textsf{lucide-icons} package (0.1.3) -- 12/05/2026}
\author{%
	Cédric Pierquet\\%
	\url{https://lucide.dev} (Source version 1.14.0)\\%
...
\hspace*{5mm}\fbox{\begin{minipage}{0.75\linewidth}{\emph{A set of 1703 free ISC License high-quality SVG/PDF icons for you to use in your web projects.}}\end{minipage}}
