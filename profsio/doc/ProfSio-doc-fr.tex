...
\verb|v0.3.5|~:~~~~Mise en conformité pour les grilles de CCF (E3) + Correction de bugs mineurs
...
Il s'agit des annexes V-1 (recto), V-2 (recto verso) et V-3 (recto verso) qui étaient anciennement nommées 7-X.
...
\subsection{Annexe V-1}

\begin{DemoCode}[listing only]
\GrilleCCFSIO[Type={V-1},Session=...,PoliceManuscrite=...]
	{NOM Prénom}
	{date}
	{intitulé court}
\end{DemoCode}

\subsection{Annexe V-2}

\begin{DemoCode}[listing only]
\GrilleCCFSIO[Type={V-2},Session=...,PoliceManuscrite=...]
	{NOM Prénom}
	{date}
	{intitulé court}
...
\subsection{Annexe V-3}

\begin{DemoCode}[listing only]
\GrilleCCFSIO[Type={V-3},Session=...,PoliceManuscrite=...]
	{NOM Prénom}
	{date}
...
\includepdf[frame,pages=-,width=\textwidth]{ProfSio-doc-annexeV1.pdf}

\newpage

\thispagestyle{empty}

\includepdf[frame,pages=-,width=\textwidth]{ProfSio-doc-annexeV2.pdf}

\newpage

\thispagestyle{empty}

\includepdf[frame,pages=-,width=\textwidth]{ProfSio-doc-annexeV3.pdf}
